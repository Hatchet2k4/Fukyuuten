...
class Widget(object):
    ...
    def setBorder(self, value):
        self.__border = int(value)
    border = property(getBorder, setBorder, doc='NOT DOCUMENTED BLEH.')
...
class Container(Widget):
    ...
    def addChild(self, child):
        ...
        assert isinstance(child, Widget), child
...
class StaticText(Widget):
    ...
    def __init__(self, x = 0, y = 0, w = 0, h = 0, *args, **kwargs):
        ...
        if isinstance(t, str):
            ...
            try:
                self._text = list(str(line) for line in t)
            except:
                assert False, 'StaticText.text property must be a string, None, or a sequence of strings. (or omitted)'
...
class ScrollableTextLabel(StaticText):
    ...
    def autoSize(self):
        super(ScrollableTextLabel, self).autoSize()
